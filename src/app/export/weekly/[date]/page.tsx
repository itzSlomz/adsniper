  ...
  return (
    <div
      ...
      style={{
        ...
        borderTop: `3px solid ${b.isSelf ? "#ec3013" : "#201e1d"}`,
        padding: "8px 10px",
        breakInside: "avoid",
      }}
    >
      <div style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
        ...
        {b.isSelf && (
          <span style={{ fontSize: 7, background: "#ec3013", color: "#fff", padding: "1px 4px", fontWeight: 800 }}>
            US
          </span>
        )}
        {b.majorPush && (
...
export default async function WeeklyExportPage({
  ...
  return (
    ...
    >
      <header style={{ borderBottom: "4px solid #ec3013", paddingBottom: 8, marginBottom: 10 }}>
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between" }}>
          <div>
            <div style={{ fontSize: 8, letterSpacing: "0.14em", color: "#ec3013", fontWeight: 800 }}>
      ...
      >
        <div style={{ fontSize: 8, letterSpacing: "0.1em", color: "#ec3013", fontWeight: 800, marginBottom: 3 }}>
      ...
      <footer style={{ marginTop: 12, paddingTop: 6, borderTop: "1px solid #d5d2d2", fontSize: 7, color: "#8a8a8a", lineHeight: 1.5 }}>
        ...
        proxy for activity, not spend — public ad libraries do not disclose budgets in Saudi Arabia.
